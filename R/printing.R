...
create_cv_object <-  function(data_location,
    ...
    checkmate::assert_string(data_location, pattern = "docs\\.google\\.com")
    ...
    read_gsheet <- function(sheet_id){
        googlesheets4::read_sheet(data_location, sheet = sheet_id, skip = 1, 
                                  col_types = "c")
    }
...
")
        purrr::walk2(cv$links, 1:n_links, 
                     function(link, index) {
